...
<login-box>
       <div id="login-box-interno">
         <div id="login-box-label"> Cadastrar Álbuns </div>
         <form action="inserirAlbum" method="post" enctype="multipart/form-data">
		  ...
		  <div class="input-div" id="input-descricao"> 
			Descrição: <input type="text" name="descricao" />
			
		  </div>
		   <div class="input-div" id="input-imagem">
			Capa: <input type="file" name="imagem" /> <br />
		  </div>
