...
<div id="principal">
	...
	<table>
		<tr>
				<th>Nome</th>
				<th>Perfil</th>
				<th>Visitar Perfil</th>
				
		</tr>
		<c:forEach var="amizade" items="${amizades}">
		 <tr>		 		
		 		<td>${amizade.nome}</td>
		 		<td><img width="100" height="100" src='<c:url  value="/resources/usuario/${amizade.login}.png" />' /></td>
		 		<td><a href="visitarPerfil?id=${amizade.usuid}">Visitar perfil</a></td>					 		
		 </tr>
		</c:forEach>
	</table>
</div>	
