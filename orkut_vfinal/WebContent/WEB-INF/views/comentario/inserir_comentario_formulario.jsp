...
<login-box>
       <div id="login-box-interno">
				Código da foto: ${fotos_id.fotid} <br />
				Código do álbum: ${fotos_id.alid}<br />
				...
				<c:if test="${usuario_logado.usuid != null}">
					...
					<form action="inserirComentario" method="post" enctype="multipart/form-data">
						...
						<div class="input-div" id="input-comentario">
							Comentário: <input type="text" name="texto" /><br />
						</div>
						<input type="hidden" name="fotos_id" value="${fotos_id.fotid}">
						<input type="hidden" name="usuario_id" value="${usuario_logado.usuid}"/><br />
