...
<login-box>
       <div id="login-box-interno">
         <div id="login-box-label"> Alterar Comunidade </div>
        
	
	
			<form action="alterarComunidade" method="post" enctype="multipart/form-data"> 
				<input type="hidden" name="comid" value="${comunidade.comid}"><br />
				<div class="input-div" id="input-nome"> 
				Nome: <input type="text" name="nome" value="${comunidade.nome}"><br />
				</div>
				...
				<input type="hidden" name="imagem" value="${comunidade.comid}"><br />
