	...
	<table>
		...
		<c:forEach var="comunidade" items="${comunidades}">
			    ...
			    <tr>
					...
					<td><a href="alterarComunidadeFormulario?comid=${comunidade.comid}">Alterar</a></td>
					<td><a href="participarComunidade?comid=${comunidade.comid}">Participar</a></td>
