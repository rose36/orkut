...
<login-box>
       <div id="login-box-interno">
         <div id="login-box-label"> Alterar Fórum </div>
        
	
	
			<form action="alterarForum" method="post"> 
				<input type="hidden" name="forid" value="${forum.forid}"><br />
				<div class="input-div" id="input-titulo"> 
				Título: <input type="text" name="titulo" value="${forum.titulo}"><br />
				</div>
				
				<div class="input-div" id="input-comunidade">	
				Comunidade: 
