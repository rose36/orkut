		    ...
		    <ul class="menu clearfix">
		        ...
		        <li><a>Fotos</a>
		        	<ul class="sub-menu clearfix">
		                ...
		                <li><a href="listarFotos">Listar Fotos</a></li>
		            </ul><!-- submenu -->
		        </li>
		        <li><a>Álbuns</a>
		        	<ul class="sub-menu clearfix">
...
<login-box>
       <div id="login-box-interno">
       			...
       			<c:if test="${usuario_logado.usuid != null}">
					...
					<form action="alterarMensagem" method="post">
	
		
						<div class="input-div" id="input-mensagem">
							<input type="hidden" name="id" value="${mensagem.menid}" />
				Comentário: <input type="text" name="texto" value="${mensagem.texto}" /><br />
						</div>
